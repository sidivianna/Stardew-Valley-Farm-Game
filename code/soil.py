...
class Plant(pygame.sprite.Sprite):
    def __init__(self, plant_type, groups, soil, check_watered):
        ...
        self.frames = import_folder(f'../Stardew Valley Game/graphics/fruit/{plant_type}')
        self.soil = soil
...
class SoilLayer:
    ...
    def create_soil_grid(self):
        ...
        for x, y, _ in load_pygame('../Stardew Valley Game/data/map.tmx').get_layer_by_name('Farmable').tiles():
